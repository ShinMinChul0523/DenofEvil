...
void CAnimationInfo::Update(FLOAT fTime)
{
...
const WORD& CAnimationInfo::Get_CurKey(void)
{
	return m_wCurKey;
}

const WORD& CAnimationInfo::Get_NextKey(void)
{
	return m_wNextKey;
}

const WORD& CAnimationInfo::Get_CurFrame(void)
{
	return m_wCurFrame;
}

const WORD& CAnimationInfo::Get_NextFrame(void)
{
	return m_wNextFrame;
}

const FLOAT& CAnimationInfo::Get_Ratio(void)
{
	return m_fRatio;
}

BOOL CAnimationInfo::Get_Playing(void)
{
...
void CAnimationInfo::Set_Key(WORD wKey)
{
