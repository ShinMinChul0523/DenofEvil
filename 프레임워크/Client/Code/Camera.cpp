...
HRESULT CCamera::Initialize(FLOAT fNear, FLOAT fFar, XMFLOAT3 vPos, XMFLOAT3 vTarget)
{
...
void CCamera::Set_Proj(FLOAT fNear, FLOAT fFar)
{
	XMMATRIX matProj = XMMatrixPerspectiveFovLH(ToRadian(45.f), FLOAT(WINCX) / FLOAT(WINCY), fNear, fFar);
